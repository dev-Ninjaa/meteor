...
export class DashboardController {
  ...
  async getDashboard(@CurrentUser('sub') userId: string, @Query() query: QueryDashboardDto) {
  ...
  async getCreated(@CurrentUser('sub') userId: string, @Query() query: QueryDashboardDto) {
  ...
  async getSubmitted(@CurrentUser('sub') userId: string, @Query() query: QueryDashboardDto) {
  ...
  async getJoined(@CurrentUser('sub') userId: string, @Query() query: QueryDashboardDto) {
